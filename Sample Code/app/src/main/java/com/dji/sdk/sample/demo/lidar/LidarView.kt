...
//import com.example.app.databinding.ViewLidarBinding
import java.util.*
...
//        binding = ViewLidarBinding.inflate(layoutInflater)
//        setContentView(binding.root)
//
//        // Используем binding для работы с кнопками
//        binding.btnSetVideoSource.setOnClickListener {
//            // Ваш код обработки нажатия кнопки
//        }
//        binding.btnUpdateLidar.setOnClickListener {
